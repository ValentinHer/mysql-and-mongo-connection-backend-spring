...
public class MongoUserController {
	...
	@Operation(summary = "Create a new user in MongoDB")
	@ApiResponses({
	...
	@Operation(summary = "Get all users in MongoDB")
	...
	@Operation(summary = "Get a user by ID from MongoDB")
	@ApiResponses({
			@ApiResponse(responseCode = "200", description = "OK"),
	...
	@Operation(summary = "Update partially a user by ID in MongoDB")
	@ApiResponses({
	...
	@Operation(summary = "Delete a user by ID in MongoDB")
	@ApiResponses({
